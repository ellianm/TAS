...
public class ClienteController {
    ...
    public ResponseEntity<List<ClienteEntity>> findAll() {
        List<ClienteEntity> clientes = this.service.findAll();
    ...
    public ResponseEntity findById(@PathVariable("id") Integer id) {
        try {
            ...
            return new ResponseEntity(new CustomErrorResponse("Não existe um cliente com esse código"),HttpStatus.NOT_FOUND);
        } catch (Exception e) {
